...
library(geosphere) #This does ~spacial trigonometry~ to calculate distance based on lat/lon
library(sp) #spacial data library http://paldhous.github.io/NICAR/2023/r-sf-mapping-geo-analysis.html
